...
def get_args():
    ...
    parser.add_argument(
        "--algo", default="ppo", help="algorithm to use: ppo | supervised"
    )
    ...
    parser.add_argument(
        "--num-forward-rollout-steps",
        type=int,
        default=8,
        help="number of forward steps in rollouts (default: 8)",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=500,
        help="maximum number of steps in a single episode (default: 500)",
    )
    ...
    parser.add_argument(
        "--dataset-dir",
        type=str,
        default="data/datasets/pointnav/habitat_test_scenes/v1/train",
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="record the results of forward passes in a video",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="mp3d",
        help="Picks which dataset to load: mp3d | gibson",
        required=True,
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Does not update the encoder features.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="results",
        help="path under log-prefix for results logs.",
    )
    ...
    parser.add_argument(
        "--debug", action="store_true", default=False, help="Sets the debug flag."
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="eval interval, one eval per n updates (default: No eval)",
    )
    ...
    parser.add_argument(
        "--encoder-network-type",
        type=str,
        required=True,
        help="Name of the encoder network type.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="ID(s) of the gpu(s) to use for rendering.",
    )
    ...
    parser.add_argument(
        ...
        "The first will be where the data unrolls are located.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Name of the task that is being used: pointnav | exploration | flee",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=-1,
        help="Number of scenes to use during training (if >0).",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Blind the network (no images fed in as input).",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="SplitNet",
        help="Name of the method that is being used.",
    )
    ...
    if not args.no_weight_update:
        ...
        assert (
            args.use_policy_loss or args.use_motion_loss or args.use_visual_loss
        ), "Must enable at least one loss"
        ...
        if args.use_motion_loss:
            assert (
                ...
                "Must update something affected by motion loss."
            )
        if args.use_policy_loss:
            assert (
                args.update_encoder_features and args.end_to_end
            ) or args.update_policy_decoder_features, (
                "Must update something affected by policy loss."
            )
        assert (
